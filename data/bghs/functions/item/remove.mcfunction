...
execute as @e[tag=spooky_spumpkin] at @s if block ~ ~ ~ air run summon item ~ ~ ~ {Item:{id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:'{"translate":"bghs.pumpkinS"}'},HideFlags:32,CustomModelData:10140004,EntityTag:{Small:1b,Invisible:1b,Tags:["spawn_spumpkin"]}}}}
