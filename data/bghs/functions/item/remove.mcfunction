...
execute as @e[tag=spooky_spumpkin] at @s if block ~ ~ ~ air run summon item ~ ~ ~ {Item:{id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:'{"translate":"bgsdp.pumpkinS"}'},HideFlags:32,CustomModelData:10140004,EntityTag:{Small:1b,Invisible:1b,Tags:["spawn_spumpkin"]}}}}
...
execute as @e[tag=frame] at @s if block ~ ~-1 ~ air run summon item ~ ~ ~ {Item:{id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:'{"translate":"bgsdp.frame"}'},HideFlags:32,CustomModelData:10140003,EntityTag:{Small:1b,Invisible:1b,Tags:["spawn_frame"]}}}}
execute as @e[tag=frame] at @s if block ~ ~-1 ~ air run kill @s

execute as @e[tag=gtrigger] at @s if block ~ ~-1 ~ air run summon item ~ ~ ~ {Item:{id:"minecraft:armor_stand",Count:1b,tag:{display:{Name:'{"translate":"bgsdp.trigger"}'},HideFlags:32,CustomModelData:10140005,EntityTag:{Small:1b,Invisible:1b,Tags:["spawn_trigger"]}}}}
